...
<style>
	...
	@media only screen and (max-width: 1200px) {
		...
		.col-xl-7.col-lg-7.col-md-12 {
			...
			/* Adjust background color for large screens */
		}
	}
	...
	@media only screen and (max-width: 992px) {
		...
		.col-xl-7.col-lg-7.col-md-12 {
			...
			/* Adjust background color for medium screens */
		}
	}
	...
	@media only screen and (max-width: 768px) {
		...
		.col-xl-7.col-lg-7.col-md-12 {
			...
			/* Adjust background color for small screens */
		}
	}
	...
	@media only screen and (max-width: 576px) {
		...
		.col-xl-7.col-lg-7.col-md-12 {
			...
			/* Adjust background color for extra small screens */
		}
	}
...
<div class="main-bnr bg-white">
	<div class=" container">
		<div class="row align-items-center mt-3">
			<div class="col-xl-5 col-lg-5 col-md-12">
				<div class="banner-media">
					<img class="media wow bounceInLeft" data-wow-delay="1.0s" src="<?= base_url('assets/img/men.png') ?>" alt="">
					<!-- 					<ul class="bnr-blocks">
						<li>
							<div class="bnr-block wow fadeInUp anm" data-wow-delay="1.5s" data-speed-x="-1" data-speed-scale="-1">
								<i class="fa-solid fa-briefcase"></i>
								<span class="block-text">SDIT</span>
							</div>
						</li>
						<li>
							<div class="bnr-block wow fadeInUp anm bg-warning" data-wow-delay="2.0s" data-speed-x="-2" data-speed-scale="-1">
								<i class="fa-solid fa-briefcase"></i>
								<span class="block-text">SMPIT</span>
							</div>
						</li>
						<li>
							<div class="bnr-block-pics wow fadeInUp anm" data-wow-delay="2.5s" data-speed-x="-3" data-speed-scale="-1">
								<i class="fa-solid fa-briefcase"></i>
								<span class="block-text">SMAIT</span>
							</div>
						</li>
					</ul>	 -->
				</div>
			</div>
			<div class="col-xl-7 col-lg-7 col-md-12" style="background-color: #FFFFFF; min-height: 100vh; padding-bottom: 50px; ">
				<div class="col-lg-12 m-b30">
					<div class="dz-contant style-1">
						<div class="section-head">
							<h2 class="title text-uppercase wow fadeInUp" data-wow-delay="1.0s">SIT Istiqamah YPAIT BALIKPAPAN</h2>
							<p style="text-align: justify;" class="text wow fadeInUp" data-wow-delay="1.2s">Sekolah Islam Terpadu Istiqamah YPAIT Balikpapan lahir dari komitmen berbagai pihak dan berbagai lembaga keislaman yang bersungguh-sungguh berupaya dalam mewujudkan Sekolah Islam Terpadu yang berkualitas untuk membentuk generasi Islam yang beriman, bertaqwa, berakhlaq mulia, cerdas, kuat dan berwawasan lingkungan. </p>
							<p style="text-align: justify;" class="text wow fadeInUp" data-wow-delay="1.2s">
								Dengan penyelenggaraan pendidikan yang menerapkan Sistem Penjaminan Mutu, SIT Istiqamah YPAIT Balikpapan berkomitmen untuk menjadi sekolah Islam terbaik unggulan di kota Balikpapan, sekaligus sekolah untuk generasi Islam yang mampu menjawab berbagai tantangan global.
							</p>
				...
				<div class="col-lg-12 m-b30">
					<div class="dz-contant style-1">
						<div class="section-head">
							<h6 class="sub-title wow fadeInUp" data-wow-delay="0.4s">Bergabunglah bersama kami</h6>
							<h2 class="title fw-bold text-uppercase wow fadeInUp" data-wow-delay="0.4s"><a href="https://istiqamahypaitb.sch.id/sd-it-balikpapan/" target="_blank"><span class="text-success">SDIT</span></a> - <a href="https://istiqamahypaitb.sch.id/smp-it-balikpapan/" target="_blank"><span class="text-primary">SMPIT</span></a> - <a href="https://istiqamahypaitb.sch.id/sma-it-balikpapan/" target="_blank"><span class="text-danger">SMAIT</span></a></h2>
							<p class=" text text-success wow fadeInUp font-w500" data-wow-delay="0.8s">The Excellence Quranic Leader and Entrepreneur School </p>
							<!-- <a class="btn btn-primary btn-lg wow fadeInUp mt-3" data-wow-delay="3.0s" href="javascript:void(0);">Segera Daftar</a> -->
							<div class="button-container">
								<button class="btn btn-primary btn-lg wow fadeInUp mt-3" data-wow-delay="3.0s" onclick="pendaftaran()">Segera Daftar</button>
								<button class="btn btn-primary btn-lg wow fadeInUp mt-3" data-wow-delay="3.0s" onclick="kunjungiKami()">Kunjungi Kami</button>
							</div>
				...
				<!-- 				<h6 class="sub-title wow fadeInUp" data-wow-delay="0.4s">Bergabunglah bersama kami</h6>
				<h2 class=" wow fadeInUp text-uppercase" id="text" data-wow-delay="0.6s">Sekolah Islam Terpadu IStiqamah YPAITB</h2>
				<p class=" text text-success wow fadeInUp font-w500" data-wow-delay="0.8s">The Excellence Quranic Leader and Entrepreneur School </p>
				<a class="btn btn-primary btn-lg wow fadeInUp mt-3" data-wow-delay="3.0s" href="javascript:void(0);">Segera Daftar</a> -->
			</div>
...
<main>
	<section class="content-inner overflow-hidden position-relative py-5">
		<div class="container">
			<header class="section-head text-center mb-5">
				<h2 class="title wow fadeInUp" style="font-size: clamp(1.5rem, 4vw, 2rem);">Kenapa Sekolah di Istiqamah YPAIT Balikpapan?</h2>
			</header>
			<div class="row justify-content-center">
				<?php
				$features = [
					['title' => 'Integrasi Pendidikan Islam dengan Kewirausahaan', 'image' => '01.jpg', 'bg_class' => 'bg-primary', 'animation' => 'fadeInLeft'],
					['title' => 'Lingkungan Sekolah yang Strategis, Aman & Nyaman', 'image' => '06.jpg', 'bg_class' => 'bg-success', 'animation' => 'fadeInRight'],
					['title' => 'Pendidik Professional, Berpengalaman & Terbaik', 'image' => '03.jpeg', 'bg_class' => 'bg-info', 'animation' => 'fadeInLeft'],
					['title' => 'Sarana & Prasarana Sekolah yang Lengkap', 'image' => '04.jpg', 'bg_class' => 'bg-warning', 'animation' => 'fadeInRight'],
					['title' => 'Ekstrakulikuler yang Menarik & Beragam', 'image' => '05.jpg', 'bg_class' => 'bg-danger', 'animation' => 'fadeInLeft'],
					['title' => 'Sekolah dengan Sistem Penjaminan Mutu (SPM)', 'image' => '02.jpg', 'bg_class' => 'bg-secondary', 'animation' => 'fadeInRight']
				];

				foreach ($features as $index => $feature) : ?>
					<article class="col-lg-6 col-md-6 mb-4">
						<div class="card h-100 shadow-sm wow <?= $feature['animation'] ?>">
							<div class="row g-0">
								<div class="col-md-4">
									<div class="image-wrapper" style="height: 100%; overflow: hidden; border: 5px solid <?= str_replace('bg-', 'var(--bs-', $feature['bg_class']) . ')'; ?>; border-radius: 5px;">
										<img src="<?= base_url('assets/img/' . $feature['image']) ?>" alt="<?= htmlspecialchars($feature['title']) ?>" class="img-fluid w-100 h-100 object-fit-cover">
									</div>
								</div>
								<div class="col-md-8">
									<div class="card-body d-flex flex-column h-100">
										<h5 class="card-title mb-3" style="font-size: clamp(0.9rem, 2.5vw, 1.1rem);"><?= htmlspecialchars($feature['title']) ?></h5>
										<div class="mt-auto">
											<span class="badge <?= $feature['bg_class'] ?> rounded-pill" style="font-size: clamp(0.8rem, 2vw, 0.9rem);"><?= str_pad($index + 1, 2, '0', STR_PAD_LEFT) ?></span>
										</div>
									</div>
								</div>
							</div>
	...
	<section class="content-inner bg-light overflow-hidden position-relative py-5">
		<div class="container">
			<header class="section-head text-center mb-4">
				<h2 class="text wow fadeInUp" style="font-size: clamp(1.3rem, 3.5vw, 1.8rem);">Info Lebih Lanjut</h2>
				<h3 class="title wow fadeInUp" style="font-size: clamp(1.5rem, 4vw, 2rem);">Program Kami</h3>
			</header>
			<div class="row">
				<article class="col-lg-4 col-md-6 col-sm-12 mb-4">
					<div class="icon-bx-wraper style-2 text-center wow fadeInUp">
						<figure class="icon-media">
							<a href="https://istiqamah.sch.id/sd-it-balikpapan/" target="_blank">
								<img src="https://istiqamahypaitb.sch.id/wp-content/uploads/2022/07/Program-SD-Islam-Istiqamah-Balikpapan.png.webp" alt="SD IT Program" class="img-fluid">
							</a>
						</figure>
					</div>
				</article>
				<article class="col-lg-4 col-md-6 col-sm-12 mb-4">
					<div class="icon-bx-wraper style-2 text-center wow fadeInUp">
						<figure class="icon-media">
							<a href="https://istiqamahypaitb.sch.id/smp-it-balikpapan/" target="_blank">
								<img src="https://istiqamahypaitb.sch.id/wp-content/uploads/2022/07/Program-SMP-Islam-Istiqamah-Balikpapan.png.webp" alt="SMP IT Program" class="img-fluid">
							</a>
						</figure>
					</div>
				</article>
				<article class="col-lg-4 col-md-6 col-sm-12 mb-4">
					<div class="icon-bx-wraper style-2 text-center wow fadeInUp">
						<figure class="icon-media">
							<a href="https://istiqamahypaitb.sch.id/sma-it-balikpapan/" target="_blank">
								<img src="https://istiqamahypaitb.sch.id/wp-content/uploads/2022/07/Program-SMA-Islam-Istiqamah-Balikpapan.png.webp" alt="SMA IT Program" class="img-fluid">
							</a>
						</figure>
					</div>
				</article>
	...
	<section class="content-inner overflow-hidden position-relative">
		<div class="container">
			<div class="section-head text-center">
				<h2 class="title wow fadeInUp" data-wow-delay="0.8s">Testimoni</h2>
			</div>
			<div class="row">
				<iframe width="100%" height="200" src="https://www.youtube.com/embed/muXvzAPfUSQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
				<iframe width="100%" height="200" src="https://www.youtube.com/embed/TeOrSG0dfXM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
				<iframe width="100%" height="200" src="https://www.youtube.com/embed/wOuPOd7hlvk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
				<iframe width="100%" height="200" src="https://www.youtube.com/embed/mJFPgTATm8g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
			</div>
		</div>
	</section>
	</section>
...
<script type="text/javascript">
	...
	function kunjungiKami() {
		window.location.href = 'https://istiqamahypaitb.sch.id'
	}
</script>